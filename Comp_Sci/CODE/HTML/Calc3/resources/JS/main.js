...
function writeBtnValue(btnValue, btnType) {
  ...
  if (btnType == "Equals") {
    //EQUALS SECTION
    var ansBoxResult = (document.getElementById("ansBox").value =
      eval(ansBoxValue));

    if (ansBoxResult > 0 && andBoxResult !== "NaN") {
    ...
    //ERROR - didnt setect a valid button type

    return alert("button type not supplied");
  }
}
